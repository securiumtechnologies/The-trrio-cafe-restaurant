...
import { ExternalLink, Search, Coffee, Utensils, Sparkles, Filter, Maximize2 } from 'lucide-react';
...
export const MenuSection: React.FC = () => {
  ...
  return (
    <section id="menu" className="py-24 bg-[#FAF7F2] scroll-mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10">
          ...
          <p className="text-sm sm:text-base text-[#2B211C]/75 leading-relaxed">
            Every dish is prepared fresh upon order in our GT Road Salkia kitchen. Explore our photos below and place direct orders via Zomato for fast delivery or pickup.
          </p>
          ...
          <a
            ...
            className="mt-4 inline-flex items-center space-x-2 text-xs font-semibold uppercase tracking-wider text-[#FAF7F2] bg-[#E23744] hover:bg-[#c92c38] px-5 py-2.5 rounded-full transition-all shadow-sm"
          >
            <span>Order & View Full Prices on Zomato</span>
          ...
          <div className="flex justify-center mb-8">
            <div className="inline-flex space-x-2 bg-[#FAF7F2] p-1 border border-[#2B211C]/10 rounded-full">
              ...
              <button
                ...
                className={`flex items-center space-x-1.5 px-4 py-1.5 text-xs font-semibold rounded-full transition-all ${
                  foodFilter === 'veg'
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold whitespace-nowrap transition-colors ${
                  selectedCategory === cat
                    ? 'bg-[#2B211C] text-[#FAF7F2]'
                    : 'bg-[#F4EFE6] text-[#2B211C]/10 hover:bg-[#2B211C]/10'
                }`}
              >
                {cat}
              </button>
        ...
        {/* Menu Grid / List with rich food images */}
            ...
            {filteredItems.map((item) => (
              ...
              >
                ...
                <div className="px-5 pb-5 pt-2 border-t border-[#2B211C]/5 flex items-center justify-between">
                  <button
                    onClick={() => setSelectedItemForModal(item)}
                    className="text-[11px] font-semibold text-[#2B211C]/70 hover:text-[#C1592A] transition-colors flex items-center space-x-1"
                  >
